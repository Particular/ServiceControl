namespace ServiceBus.Management.AcceptanceTests
{
    ...
    public class When_a_retry_for_a_failed_message_is_successful : AcceptanceTest
    {
        ...
        public void Should_show_up_as_resolved_when_doing_a_single_retry()
        {
            ...
            Assert.AreEqual("Failed message ServiceBus.Management.AcceptanceTests.When_a_retry_for_a_failed_message_is_successful+MyMessage resolved by retry", eventLogItems.First().Description);

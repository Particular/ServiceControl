...
//        {
//            ///TODO: To be visited when refactoring the edit page
...
//            //    .MustNotBeIn(x => instances.UsedQueueNames(x.SelectedTransport, x.InstanceName, x.ConnectionString)).WithMessage(Validations.MSG_QUEUE_ALREADY_ASSIGNED)
...
//            //    .NotEmpty()
//            //    .ValidPort()
//            //    .MustNotBeIn(x => instances.UsedPorts(x.InstanceName))

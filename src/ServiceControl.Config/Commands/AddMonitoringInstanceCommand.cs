...
namespace ServiceControl.Config.Commands
{
    ...
    class AddMonitoringInstanceCommand : AbstractCommand<object>
    {
        ...
        public override void Execute(object obj)
        {
            ...
            {
                windowManager.ShowMessage("LICENSE ERROR", $"Install could not continue due to an issue with the current license. {licenseCheckResult.Message}. You can extend your Trial License at <c:ExtendTrialHyperlink/>.", hideCancel: true);
                return;
            }

namespace ServiceControl.Config.Commands
{
    ...
    class UpgradeServiceControlInstanceCommand : AwaitableAbstractCommand<InstanceDetailsViewModel>
    {
        ...
        public override async Task ExecuteAsync(InstanceDetailsViewModel model)
        {
            ...
            {
                windowManager.ShowMessage("LICENSE ERROR", $"Upgrade could not continue due to an issue with the current license. {licenseCheckResult.Message}. You can extend your Trial License at <c:ExtendTrialHyperlink/>.", hideCancel: true);
                return;
            }

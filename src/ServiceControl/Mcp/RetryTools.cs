...
public class RetryTools(IMessageSession messageSession, RetryingManager retryingManager, ILogger<RetryTools> logger)
{
    ...
    public async Task<McpRetryOperationResult> RetryFailedMessage(
    ...
    public async Task<McpRetryOperationResult> RetryFailedMessages(
    ...
    public async Task<McpRetryOperationResult> RetryFailedMessagesByQueue(
    ...
    public async Task<McpRetryOperationResult> RetryAllFailedMessages()
    {
    ...
    public async Task<McpRetryOperationResult> RetryAllFailedMessagesByEndpoint(
    ...
    public async Task<McpRetryOperationResult> RetryFailureGroup(

namespace ServiceControl.Recoverability
{
    ...
    public interface IRetryOperationProgressNotifier
    {
        ...
        void Completed(string requestId, RetryType retryType, bool failed, Progress progress, DateTime startTime, DateTime completionTime, string originator, int numberOfMessagesProcessed, DateTime last, string classifier);
    }
}
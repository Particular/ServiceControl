namespace ServiceControl.MessageFailures.Handlers
{
    ...
    class MessageFailureResolvedDomainHandler : IDomainHandler<MessageFailureResolvedByRetry>
    {
        ...
        {
            //HINT: This event has been published when the SC main instance received successful retry confirmation and the state has been updated via patch commands generated by RetryConfirmationProcessor
            if (domainEvent.StateUpdated)
            {
                return;
            }

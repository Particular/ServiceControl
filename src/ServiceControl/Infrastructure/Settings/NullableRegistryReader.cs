namespace ServiceBus.Management.Infrastructure.Settings
{
    ...
    class NullableRegistryReader<T> where T : struct
    {
        /// <summary>
        ...
        /// </returns>
        public static T? Read(string subKey, string name, T? defaultValue)
        {
        ...
        static readonly ILog Logger = LogManager.GetLogger(typeof(NullableRegistryReader<T>));
    }
}
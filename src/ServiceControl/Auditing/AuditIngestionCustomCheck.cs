namespace ServiceControl.Auditing
{
    ...
    class AuditIngestionCustomCheck(AuditIngestionCustomCheck.State criticalErrorHolder)
        : CustomCheck("Audit Message Ingestion Process", "ServiceControl Health", TimeSpan.FromSeconds(5))
    {

namespace ServiceControl.Persistence.Tests.RavenDB.Expiration
{
    ...
    public class MessageExpiryTests : RavenPersistenceTestBase
    {
        ...
        public async Task SingleMessageMarkedAsArchiveShouldExpire()
        {
            ...
            Assert.That(error.Results.Count, Is.EqualTo(1), "Failed message should be available to query after ingestion");
        ...
        public async Task AllMessagesInUnArchivedGroupShouldNotExpire()
        {
            ...
            Assert.That(error.Results.Count, Is.EqualTo(2), "Failed message should be available to query after ingestion");
        ...
        public async Task SingleMessageMarkedAsResolvedShouldExpire()
        {
            ...
            Assert.That(errors.Results.Count, Is.EqualTo(1), "Failed message should be available to query after ingestion");
        ...
        public async Task EventLogItemShouldExpire()
        {
            ...
            Assert.That(logItems.Count, Is.EqualTo(1), "Event log items should be available to query.");

namespace ServiceControl.PersistenceTests
{
    ...
    class MagicStringTypeTests
    {
        ...
        {
            var typeNamespace = DataStoreConfig.RavenDB5PersistenceTypeFullyQualifiedName.Split(',')[1].Trim();
            var typeFullName = DataStoreConfig.RavenDB5PersistenceTypeFullyQualifiedName.Split(',')[0].Trim();

namespace ServiceControl.Transports.RabbitMQ
{
    ...
    class ConnectionConfiguration
    {
        ...
        public static ConnectionConfiguration Create(string connectionString, string endpointName)
        {
            ...
            var requestedHeartbeat = TimeSpan.FromSeconds(GetValue(dictionary, "requestedHeartbeat", ushort.TryParse, defaultRequestedHeartbeat, invalidOptionsMessage));
            ...
            var rabbitMQVersion = FileVersionInfo.GetVersionInfo(typeof(RabbitMQTransport).Assembly.Location);

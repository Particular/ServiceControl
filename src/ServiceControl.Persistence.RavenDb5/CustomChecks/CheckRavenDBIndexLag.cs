namespace ServiceControl
{
    ...
    {
        public CheckRavenDBIndexLag(DocumentStoreProvider storeProvider)
        ...
        {
            var statistics = await storeProvider.Store.Maintenance.SendAsync(new GetStatisticsOperation());

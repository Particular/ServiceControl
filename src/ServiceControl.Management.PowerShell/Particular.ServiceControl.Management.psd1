...
Copyright = '© 2010-{{Date}} NServiceBus Ltd. All rights reserved'
...
FormatsToProcess = 'Particular.ServiceControl.Management.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('Particular.ServiceControl.Management.psm1')

...
class AuditPartitionCustomCheck(IServiceScopeFactory scopeFactory, IAuditPartitionManager partitions, TimeProvider timeProvider, EFPersisterSettings settings)

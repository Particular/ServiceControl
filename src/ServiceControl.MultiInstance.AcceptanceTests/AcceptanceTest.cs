namespace ServiceBus.Management.AcceptanceTests
{
    ...
    abstract class AcceptanceTest : NServiceBusAcceptanceTest, IAcceptanceTestInfrastructureProvider
    {
        ...
        protected Action<ServiceControl.Audit.Infrastructure.Settings.Settings> CustomServiceControlAuditSettings = c => { };
        ...
        protected static string ServiceControlAuditInstanceName { get; } = ServiceControl.Audit.Infrastructure.Settings.Settings.DEFAULT_SERVICE_NAME;

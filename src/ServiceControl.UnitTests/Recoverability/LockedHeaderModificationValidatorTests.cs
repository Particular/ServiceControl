namespace ServiceControl.UnitTests.Recoverability
{
    ...
    public class LockedHeaderModificationValidatorTests
    {
        ...
        IList<KeyValuePair<string, string>> editedMessageHeaders;
        ...
        public void Headers_not_in_the_locked_list_should_not_be_treated_as_a_modification()
        {
            ...
            editedMessageHeaders = new List<KeyValuePair<string, string>> { new KeyValuePair<string, string>("foo", "asdf") };
        ...
        {
            lockedHeaders = new [] { "NServiceBus.MessageId" };
            editedMessageHeaders = new List<KeyValuePair<string, string>>{new KeyValuePair<string, string>("NServiceBus.MessageId","asdf")};
        ...
        {
            lockedHeaders = new[] { "NServiceBus.MessageId" };
            editedMessageHeaders = new List<KeyValuePair<string, string>> { new KeyValuePair<string, string>("foo", "bar") };
        ...
        {
            lockedHeaders = new[] { "NServiceBus.MessageId" };
            editedMessageHeaders = new List<KeyValuePair<string, string>> { new KeyValuePair<string, string>("NServiceBus.MessageId", "bar") };
            originalMessageHeaders = new Dictionary<string, string> { { "NServiceBus.MessageId", "asdf" } };
            Assert.IsTrue(validator.Check(lockedHeaders, editedMessageHeaders, originalMessageHeaders));
        }

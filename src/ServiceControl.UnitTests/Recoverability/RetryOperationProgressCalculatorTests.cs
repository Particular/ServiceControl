namespace ServiceControl.UnitTests.Operations
{
    ...
    public class RetryOperationProgressCalculatorTests
    {
        ...
        {
            var calculated = RetryOperationProgressCalculator.CalculateProgress(2000, 1000, 0, 0, RetryState.Preparing);
        ...
        {
            var calculated = RetryOperationProgressCalculator.CalculateProgress(2000, 2000, 0, 0, RetryState.Preparing);
            Assert.AreEqual(1.0, calculated);
        }
        ...
        {
            var calculated = RetryOperationProgressCalculator.CalculateProgress(2000, 2000, 2000, 0, RetryState.Forwarding);
            Assert.AreEqual(1.0, calculated);
        }
        ...
        {
            var calculated = RetryOperationProgressCalculator.CalculateProgress(2000, 2000, 1000, 1000, RetryState.Forwarding);
            Assert.AreEqual(1.0, calculated);
        }

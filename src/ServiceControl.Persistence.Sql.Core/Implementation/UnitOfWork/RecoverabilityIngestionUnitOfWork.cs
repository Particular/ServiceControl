    ...
    public async Task RecordFailedProcessingAttempt(MessageContext context, FailedMessage.ProcessingAttempt processingAttempt, List<FailedMessage.FailureGroup> groups)
    {
        ...
        /*
                ...
                if (existingMessage != null)
                {
                    ...
                    existingMessage.Body = BuildSearchableText(processingAttempt.Headers, context.Body); // Populate Body for all databases
        ...
        List<FailedMessage.ProcessingAttempt> attempts = [processingAttempt];
        ...
        var failedMessageEntity = new FailedMessageEntity
        {
            ...
            HeadersJson = "{}", //JsonSerializer.Serialize(processingAttempt.Headers, RecoverabilityJsonContext.Default.DictionaryStringString),
            Body = BuildInlineBody(processingAttempt.Headers, context.Body),

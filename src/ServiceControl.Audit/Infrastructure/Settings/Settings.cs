namespace ServiceControl.Audit.Infrastructure.Settings
{
    ...
    public class Settings
    {
        public Settings(string transportType = null, string persisterType = null, LoggingSettings loggingSettings = null)
        {
            ...
            MaximumConcurrencyLevel = SettingsReader.Read(SettingsRootNamespace, "MaximumConcurrencyLevel", TransportType != null ? TransportManifestLibrary.Find(TransportType)?.MaximumAuditConcurrencyLevel ?? 32 : 32);

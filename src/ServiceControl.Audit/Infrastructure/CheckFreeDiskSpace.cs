namespace ServiceControl.Audit.Infrastructure
{
    ...
    {
        public CheckFreeDiskSpace(Settings.Settings settings) : base("ServiceControl.Audit database", CustomCheckCategories.ServiceControlAuditHealth, TimeSpan.FromMinutes(5))
        {

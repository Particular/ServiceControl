namespace ServiceControl.Audit.Infrastructure
{
    ...
    {
        public CheckFreeDiskSpace(Settings.Settings settings) : base("ServiceControl.Audit database", CustomChecksCategories.ServiceControlAuditHealth, TimeSpan.FromMinutes(5))
        {

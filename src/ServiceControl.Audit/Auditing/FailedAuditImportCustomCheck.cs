namespace ServiceControl.Audit.Auditing
{
    ...
    class FailedAuditImportCustomCheck(IFailedAuditStorage store, ILogger<FailedAuditImportCustomCheck> logger) : CustomCheck("Audit Message Ingestion", "ServiceControl.Audit Health", TimeSpan.FromHours(1))
    {

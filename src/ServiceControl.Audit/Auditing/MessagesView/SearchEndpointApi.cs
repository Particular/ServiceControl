namespace ServiceControl.Audit.Auditing.MessagesView
{
    ...
    public class SearchEndpointApi : ApiBase<SearchEndpointApi.Input, IList<MessagesView>>
    {
        ...
        protected override async Task<QueryResult<IList<MessagesView>>> Query(HttpRequestMessage request, Input input)
        {
            ...
            return await DataStore.QueryMessagesByReceivingEndpointAndKeyword(input.Endpoint, input.Keyword, pagingInfo, sortInfo);
        }

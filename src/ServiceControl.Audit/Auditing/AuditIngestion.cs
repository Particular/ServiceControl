namespace ServiceControl.Audit.Auditing
{
    ...
    class AuditIngestion : BackgroundService
    {
        ...
        {
            logger.LogInformation("Ingestion settings: TargetMessageIngestionRate={TargetMessageIngestionRate}, MaxConcurrencyLevel={MaxConcurrencyLevel}, BatchSize={BatchSize}, MaxParallelWriters={MaxParallelWriters}, BatchTimeout={BatchTimeout}",
                settings.TargetMessageIngestionRate?.ToString() ?? "(not set)",
                settings.MaximumConcurrencyLevel?.ToString() ?? "(transport default)",
                BatchSize,
                MaxParallelWriters,
                BatchTimeout);

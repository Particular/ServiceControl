namespace Particular.ThroughputCollector.UnitTests
{
    ...
    class ThroughputCollector_ThroughputSummary_Tests : ThroughputCollectorTestFixture
    {
        ...
        [
            new Endpoint { Name = "Endpoint1", SanitizedName = "Endpoint1", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 50 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 55 }] },
            new Endpoint { Name = "Endpoint2", SanitizedName = "Endpoint2", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 60 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 65 }] },
            new Endpoint { Name = "Endpoint3", SanitizedName = "Endpoint3", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 75 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 50 }] }
        ];
        ...
        [
            ...
            new Endpoint { Name = "Endpoint2", SanitizedName = "Endpoint2", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 60 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 65 }] },
            new Endpoint { Name = "Endpoint3", SanitizedName = "Endpoint3", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 50 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 55 }] },
            new Endpoint { Name = "Endpoint3", SanitizedName = "Endpoint3", ThroughputSource = ThroughputSource.Monitoring, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 40 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 45 }] }
        ];
        ...
        [
            ...
            new Endpoint { Name = "Endpoint1", SanitizedName = "Endpoint1", ThroughputSource = ThroughputSource.Monitoring, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 60 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 65 }] },
            new Endpoint { Name = "Endpoint2", SanitizedName = "Endpoint2", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 60 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 65 }] },
            new Endpoint { Name = "Endpoint2", SanitizedName = "Endpoint2", ThroughputSource = ThroughputSource.Audit, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 61 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 64 }] },
            new Endpoint { Name = "Endpoint3", SanitizedName = "Endpoint3", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 50 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 57 }] },
            new Endpoint { Name = "Endpoint3", SanitizedName = "Endpoint3", ThroughputSource = ThroughputSource.Monitoring, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 40 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 45 }] },
            new Endpoint { Name = "Endpoint3", SanitizedName = "Endpoint3", ThroughputSource = ThroughputSource.Audit, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 42 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 47 }] }
        ];
        ...
        [
            ...
            new Endpoint { Name = "Endpoint1_", SanitizedName = "Endpoint1", ThroughputSource = ThroughputSource.Audit, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 60 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 65 }] },
        ];

        Endpoint ServiceControlEndpoint = new Endpoint { Name = "Particular.ServiceControl", SanitizedName = "Particular.ServiceControl", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 500 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 600 }] };
        Endpoint AuditEndpoint = new Endpoint { Name = "audit", SanitizedName = "audit", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 500 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 600 }] };
        Endpoint ErrorEndpoint = new Endpoint { Name = "error", SanitizedName = "error", ThroughputSource = ThroughputSource.Broker, DailyThroughput = [new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-1), TotalThroughput = 500 }, new EndpointThroughput { DateUTC = System.DateTime.UtcNow.Date.AddDays(-2), TotalThroughput = 600 }] };
    }
}
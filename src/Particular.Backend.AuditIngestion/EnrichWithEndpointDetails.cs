namespace ServiceControl.EndpointControl
{
    ...
    public class EnrichWithEndpointDetails : ImportEnricher
    {
        ...
        {
            var sendingEndpoint = EndpointDetailsParser.ParseSendingEndpoint(message.PhysicalMessage.Headers);
            ...
            var receivingEndpoint = EndpointDetailsParser.ParseProcessingEndpoint(message.PhysicalMessage.Headers);

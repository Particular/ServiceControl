...
<# 
    ...
    .Parameter Transport
    Specifies the Transport files to install. Valid options are Azure Service Bus - Forwarding topology, Azure Service Bus - Endpoint-oriented topology, Azure Service Bus,  AzureStorageQueue, MSMQ, AmazonSQS, SQLServer, RabbitMQ - Direct-Routing topology, and RabbitMQ - Conventional-Routing topology
...
Function Add-ServiceControlInstance {
	PARAM(
		...
		[Parameter(Mandatory)] [ValidateSet("Azure Service Bus - Endpoint-oriented topology","Azure Service Bus - Forwarding topology", "Azure Service Bus", "AzureStorageQueue","MSMQ","SQLServer","AmazonSQS","RabbitMQ - Direct-Routing topology","RabbitMQ - Conventional-Routing topology")] $Transport,
		[string] $DisplayName,

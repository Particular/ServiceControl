...
<# 
    ...
    .Parameter Transport
    Specifies the Transport files to install. Valid options are Azure Service Bus - Forwarding topology, Azure Service Bus - Endpoint-oriented topology, Azure Service Bus,  Azure Storage Queue, MSMQ, AmazonSQS, SQLServer, RabbitMQ - Direct routing topology, and RabbitMQ - Conventional routing topology
...
Function Add-ServiceControlInstance {
	PARAM(
		...
		[Parameter(Mandatory)] [ValidateSet("Azure Service Bus - Endpoint-oriented topology","Azure Service Bus - Forwarding topology", "Azure Service Bus", "Azure Storage Queue","MSMQ","SQLServer","AmazonSQS","RabbitMQ - Direct routing topology","RabbitMQ - Conventional routing topology")] $Transport,
		[string] $DisplayName,

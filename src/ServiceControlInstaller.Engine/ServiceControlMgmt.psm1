...
<# 
    ...
    .Parameter Transport
    Specifies the Transport files to install. Valid options are Azure Service Bus - Forwarding topology (Old), Azure Service Bus - Endpoint-oriented topology (Old), Azure Service Bus,  Azure Storage Queue, MSMQ, AmazonSQS, SQL Server, RabbitMQ - Direct routing topology (Old), and RabbitMQ - Conventional routing topology
...
Function Add-ServiceControlInstance {
	PARAM(
		...
		[Parameter(Mandatory)] [ValidateSet("Azure Service Bus - Endpoint-oriented topology (Old)","Azure Service Bus - Forwarding topology (Old)", "Azure Service Bus", "Azure Storage Queue","MSMQ","SQL Server","AmazonSQS","RabbitMQ - Direct routing topology (Old)","RabbitMQ - Conventional routing topology")] $Transport,
		[string] $DisplayName,

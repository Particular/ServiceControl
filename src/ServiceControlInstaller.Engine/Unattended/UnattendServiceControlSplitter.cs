        ...
        Result ValidateUpgradeAction(ServiceControlInstance instance)
        {
            ...
            switch (recommendedUpgradeAction)
            {
                ...
                case RequiredUpgradeAction.ConvertToAudit:
                    return Result.Failed("This instance cannot have an Audit instance split from it. This instance has no recommended upgrade action", RequiredUpgradeAction.ConvertToAudit);

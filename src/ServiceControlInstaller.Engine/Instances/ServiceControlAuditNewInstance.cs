...
{
    public static ServiceControlAuditNewInstance CreateWithDefaultPersistence() => CreateWithPersistence(StorageEngineNames.RavenDB);
    ...
    protected override void RunSetup() => InstanceSetup.Run(this);

    protected override void ValidateMaintenancePort() => DatabaseMaintenancePortValidator.Validate(this);

    protected override void ValidateQueueNames() => QueueNameValidator.Validate(this);

    protected override void ValidateServiceAccount() => ServiceAccountValidation.Validate(this);

    protected override void ValidateConnectionString() => ConnectionStringValidator.Validate(this);
}
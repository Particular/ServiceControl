    ...
    public  class ServiceControlCoreTransports
    {
        ...
        public static List<TransportInfo> All => new List<TransportInfo>
        {
            new TransportInfo
            {
                ...
                Matches = name =>
                {
                    return name.Equals("ServiceControl.Transports.ASB.ASBForwardingTopologyTransportCustomization, ServiceControl.Transports.ASB", StringComparison.OrdinalIgnoreCase);
                }
            },
            new TransportInfo
            {
                ...
                Matches = name =>
                {
                    return name.Equals("ServiceControl.Transports.ASB.ASBEndpointTopologyTransportCustomization, ServiceControl.Transports.ASB", StringComparison.OrdinalIgnoreCase)
            ...
            new TransportInfo
            {
                ...
                Matches = name =>
                {
                    return name.Equals("ServiceControl.Transports.ASQ.ASQTransportCustomization, ServiceControl.Transports.ASQ", StringComparison.OrdinalIgnoreCase)
            ...
            new TransportInfo
            {
                ...
                Matches = name =>
                {
                    return name.Equals("ServiceControl.Transports.Msmq.MsmqTransportCustomization, ServiceControl.Transports.Msmq", StringComparison.OrdinalIgnoreCase)
            ...
            new TransportInfo
            {
                ...
                Matches = name =>
                {
                    return name.Equals("ServiceControl.Transports.SqlServer.SqlServerTransportCustomization, ServiceControl.Transports.SqlServer", StringComparison.OrdinalIgnoreCase)
            ...
            {
                Name = "RabbitMQ",
                TypeName = "ServiceControl.Transports.RabbitMQ.RabbitMQTransportCustomization, ServiceControl.Transports.RabbitMQ",
                SampleConnectionString = "host=<HOSTNAME>;username=<USERNAME>;password=<PASSWORD>",
                Matches = name =>
                {
                    return name.Equals("ServiceControl.Transports.RabbitMQ.RabbitMQTransportCustomization, ServiceControl.Transports.RabbitMQ", StringComparison.OrdinalIgnoreCase)

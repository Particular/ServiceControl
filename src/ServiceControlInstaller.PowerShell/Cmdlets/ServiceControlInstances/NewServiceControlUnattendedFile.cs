...
namespace ServiceControlInstaller.PowerShell
{
    ...
    public class NewServiceControlUnattendedFile : PSCmdlet
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = "Specify the maintenance port number to listen on. If this is the only ServiceControl instance then 33334 is recommended")]
        [ValidateRange(1, 49151)]

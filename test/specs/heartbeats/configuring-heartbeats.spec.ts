...
describe("FEATURE: Heartbeats configuration", () => {
  ...
  describe("RULE: Toggling on/off heartbeat monitoring for endpoints should be possible", () => {
    ...
    */
    ...
    test.todo("EXAMPLE: Clicking the monitoring toggle for an endpoint should activate heartbeat monitoring of the endpoint");
    /* SCENARIO
  ...
  describe("RULE: Filtering endpoints by name should be possible", () => {
    test.todo("EXAMPLE: Filter string matches a subset of endpoint names should display only those endpoints");
    ...
    */
    ...
    test.todo("EXAMPLE: Filter string matches no endpoint names should display no endpoints");
    /* SCENARIO
      Given 3 endpoint instances
        Name |
        Foo1
    ...
    */
    ...
    test.todo("EXAMPLE: The filter string should be persisted on page refresh and across tabs");
    /* SCENARIO
